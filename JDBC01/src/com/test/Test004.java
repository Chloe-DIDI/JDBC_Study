...
public class Test004
{
   public static void main(String[] args)
   {
      ...
      do
      {
         ...
         if (conn != null)
         {
            ...
            try
            {
               ...
               //쿼리문 준비
               //(Test004)   String sql = "INSERT INTO TBL_MEMBER(SID, NAME, TEL) VALUES(2, '채지윤', '010-2222-2222')";
      ...
      System.out.print("데이터베이스 연결 닫힘~!!!");
      System.out.print("프로그램 종료됨~!!!");
